...
| Region | AMI ID | Binance.com |
|--------|--------|-------------|
| `us-east-2` (Ohio) | `ami-0e1b7cd800de666a8` | ❌ blocked from US |
| `eu-central-1` (Frankfurt) | `ami-067e0e4a6afd32b08` | ✅ |
| `ap-southeast-1` (Singapore) | `ami-0e60b60c848292caf` | ✅ |

If you stream crypto/market data (e.g. Binance), pick a **non-US** region — `binance.com`
returns HTTP 451 from US regions.
